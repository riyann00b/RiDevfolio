...
export const ProjectsSection = () => {
  return <div>
    <div className="container">
      ...
      <p className="text-center text-white/60 mt-4">See How I develop the Future</p>
      <div className="flex flex-col mt-10">
        {portfolioProjects.map((project) => (
            <div
                key={project.title}
                className="bg-gray-800 rounded-3xl relative z-0
                overflow-hidden after:z10 after:content-[''] after:absolute
                after:inset-0 after:outline-2 after:outline
                after:outline-offset-2 rounded-3xl after:outline-white/20
                px-8 pt-8 "
            >
              <div>
