  ...
  return (
      <section className="pb-16 lg:py-24">
        <div className="container">
          ...
          <p className="text-center md:text-lg lg:text-xl text-white/60 mt-4 max-w-md mx-auto">See How I develop the Future</p>
          <div className="mt-10 md:mt-20 flex flex-col mt-10 gap-20">
            {portfolioProjects.map((project) => (
                <div
                    ...
                    after:outline-offset-2 rounded-3xl after:outline-white/20 px-8 pt-8 md:pt-12
                ...
                >
                  ...
                  <div className="lg:grid lg:grid-cols-2 lg:gap-16  ">
                    <div className="lg:pb-16">
                      ...
                      <ul className="flex flex-col gap-4 mt-4 md:mt-5">
                        {project.results.map((result) => (
                            <li key={result.title} className="flex gap-2 text-sm md:text-base text-white/50">
                              <CheckCircleIcon className="w-5 h-5 md:size-6"/>
                      ...
                      <a href={project.link}>
                        <button
                            className="bg-white text-gray-950 h-12 w-full md:w-full px-6 rounded-xl font-semibold inline-flex items-center justify-center gap-2 mt-8">
