...
- **Components** (`src/components/`): Individual Astro components for each section (Hero, About, Projects, Experience, Education, Certifications, Header, Footer)
...
- certifications: array of {name, issuer, dateRange, description, skills, link (optional)}